  ...
  return (
    <Layout pageTitle="Circuito da Coragem" pageDescription="Mentoria individual" headerImage={banner}>
      ...
      <section className="bodySection backgroundA">
        ...
        <p>Intenção: A coragem para criar e se posicionar, reconhecer os seus e talentos e fortalecer o seu projeto.</p>
      ...
      <section className="bodySection backgroundB">
        ...
        <p>“Sinto-me comprometido com a vida”</p>

        <p>Intenção: Desenvolver a coragem para não desistir e seguir em frente reconhecendo a necessidade do momento, se conectando com o seu projeto e com a sua força, determinação e alegria.</p>
